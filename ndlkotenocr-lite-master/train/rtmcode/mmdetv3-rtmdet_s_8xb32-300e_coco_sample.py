...
data_root = '/hdd2/rtmdet/layoutinputs/'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/hdd2/rtmdet/layoutinputs/kotensekicocovalid/kotensekicocovalid.json',
        backend_args=None,
        data_prefix=dict(
            img='/hdd2/rtmdet/layoutinputs/kotensekicocovalid/img/'),
        data_root='/hdd2/rtmdet/layoutinputs/',
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/hdd2/rtmdet/layoutinputs/kotensekicocotrain/kotensekicocotrain.json',
        backend_args=None,
        data_prefix=dict(
            img='/hdd2/rtmdet/layoutinputs/kotensekicocotrain/img/'),
        data_root='/hdd2/rtmdet/layoutinputs/',
...
work_dir = '/hdd2/rtmdet/work_dir_mmdetv3_rtmdet_s'
