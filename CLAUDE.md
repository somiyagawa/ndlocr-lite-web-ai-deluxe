...
NDL-OCR Lite Web AI Ultra（旧称 NDLOCR-Lite Web AI Deluxe）は、国立国会図書館の NDLOCR-Lite をベースにした、ブラウザ完結型OCR Webアプリケーションである。yuta1984/ndlocrlite-web をフォークし、AI校正機能と Ultra 機能を追加している。
